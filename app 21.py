...
# Simulate button and prompt outside the tab
simulate = st.button("Simulate Flight")
if simulate:
    st.session_state.simulate_flight = True
    st.success("✅ Simulation started. Scroll to the **Simulate Flight** tab to view real-time telemetry.")

# Tabs for navigation
tab1, tab2 = st.tabs(["Estimator (Static Preview)", "Simulate Flight"])

with tab1:
    st.write("Flight time estimate and power settings are configured above.")
